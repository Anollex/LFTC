...
typedef enum{
	...
	,OP_ADD_F       // adds 2 double values from stack
	,OP_SUB_F       // subtracts 2 double values from stack
	,OP_LESS_F      // compares 2 double values from stack
	}Opcode;
...
// generates a test program for double
